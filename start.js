  ...
  var op4=document.getElementById('op4');
      ...
      var app={
                questions:[
                          ...
                          {q:'A stylesheet file is aved in ____ format ?',options:['.html','.jar','.css','.js'],answer:3},
                          {q:'A javascript file is saved in ____ format  ?',options:['.js','.html','.css','xml'],answer:1}
                          ],
                index:0,
                load:function(){
                	   if(this.index<=this.questions.length-1){
                        quizBox.innerHTML=this.index+1+"/"+this.questions.length+". "+this.questions[this.index].q;      
